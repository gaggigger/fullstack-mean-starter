(function (window, angular) {
  ...
  dd.run(['$templateCache', function ($templateCache) {
    $templateCache.put('ngDropdowns/templates/dropdownSelect.html', [
      '<div class="noselect mtr-dropdown"><div ng-class="{\'disabled\': dropdownDisabled}" class="outer-container wrap-dd-select" tabindex="0">',
      '<span class="mtr-dropdown-span selected" ng-click="vm.childMenuVisibility = !vm.childMenuVisibility" class="noselect" ng-class="(vm.childMenuVisibility)?\'active\':\'\'">{{dropdownModel[labelField]}}</span>',
      '<ul ng-if="vm.childMenuVisibility === true" class="dropdown" > ',
      '<li ng-repeat="item in dropdownSelect"',
      ' class="dropdown-item"',
      ' dropdown-select-item="item"',
      ' dropdown-item-label="labelField" ng-click="vm.childMenuVisibility = !vm.childMenuVisibility">',
      '</li>',
      '</ul>',
      '</div></div>'
    ].join(''));
    ...
    $templateCache.put('ngDropdowns/templates/dropdownSelectItem.html', [
      ...
      '<span  class="icon" ng-class="dropdownSelectItem.iconCls">',
      '',
      '</span>',
      '</div>',
...
//
//     this.mtrOptions = [
//       {text: "My First Option", value:3},
//       {text: "My First Option", value:78, icon:"ion-ios-infinite"},
//       {text: "with icon ", icon: "ion-ionic", value: 55}
//     ];
//     this.$scope.$watch('selectedOption', (value)=>{
//       if(value){
//         console.log(value);
//
//       }
...
//     this.$scope.selectedOption = selectedOption;
//     this.childMenuVisibility = false;
//     // this.matar = this.selectedOption;
//   }
// }
